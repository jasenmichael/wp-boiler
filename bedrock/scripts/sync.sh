...
DEVSITE="https://$dev_host"

PRODDIR="web@$prod_host:/srv/www/esits.org/shared/uploads/"
PRODSITE="https://$prod_host"

STAGDIR="web@$stag_host:/srv/www/example/shared/uploads/"
STAGSITE="https://$stag_host"
